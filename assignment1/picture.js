...
window.onload = function init()
{
    ...
    var vBufferId = gl.createBuffer(); //좌표 지정?
    /* Create buffer for color */
    var cBufferId = gl.createBuffer(); // 색칠하기?
    ...
    /* Draw 3 clouds */
    setObject(vBufferId, cBufferId, cld, cldColor, 30, gl.TRIANGLES, [-0.1, 0.0, 0.2, 0], program);    
    ...
    setObject(vBufferId, cBufferId, flower, flwColor, 9, gl.TRIANGLE_FAN, [0, 0, 0, 0], program);
