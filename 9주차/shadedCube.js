...
var materialSpecular = vec4(1.0, 0.8, 0.0, 1.0); //white
...
window.onload = function init()
{
    ...
    var specularProudct = mult(lightSpecular, materialSpecular);
    ...
    gl.uniform4fv(gl.getUniformLocation(program, "specularProudct"), flatten(specularProudct));
